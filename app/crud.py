...
def get_tables_by_min_capacity(db: Session, min_capacity: int) -> list[models.RestaurantTable]:
    return db.query(models.RestaurantTable).filter(models.RestaurantTable.capacity < min_capacity).all()
